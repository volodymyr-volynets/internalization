...
class Translations extends Base
{
    ...
    public $elements = [
        ...
        'organizations_container' => [
            'row1' => [
                'in_translorg_organization_id' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Organization', 'domain' => 'organization_id', 'required' => true, 'null' => true, 'details_unique_select' => true, 'percent' => 95, 'method' => 'select', 'options_model' => '\Numbers\Users\Organizations\Model\Organizations::optionsActive', 'onchange' => 'this.form.submit();'],
    ...
    public function finalize(& $form)
    {
        ...
        if (!$form->hasErrors()) {
            $query = Missing::queryBuilderStatic()->delete();
